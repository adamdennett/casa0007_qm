...
england_school_2022_23 <- england_school_information |>
  safe_left_join(england_abs) |>
  safe_left_join(england_census) |>
  safe_left_join(england_ks4final) |>
...
-   The general form of a linear regression model is:
    ...
    -   (\beta\_1, \beta\_2, ..., \beta\_n) are the coefficients for each independent variable
