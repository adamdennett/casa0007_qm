...
::: {.column width="50%"}
![](images/Python-logo-notext.svg.png){width="20%"} ![](images/R_logo.svg.png){width="20%"}
![](images/Stata_logo_med_blue.png){width="20%"}
![](images/spss-1-logo-png-transparent.png){width="20%"}
![](images/statsmodels-logo-v2-horizontal.svg){width="20%"}
![](images/tidy_models.png){width="20%"}
:::
:::::
