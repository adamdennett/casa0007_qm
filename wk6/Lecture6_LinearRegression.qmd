...
-   Scatter plots are an excellent (probably the best) way to understand the relationship between two continuous variables
-   But, statistical software will provide you with the key parameters that describe your scatter plot - plus some other useful additional information
