...
```{mermaid}
flowchart TD
    A["<img src='images/Data.png'>"] --> B[<img src='images/Book.png'>]
    B[<img src='images/Book.png'>] --> A["<img src='images/Data.png'>"]
...
::: {.column width="50%"}
[![](images/being_interdisciplinary.jpg){width="50%"}](https://uclpress.co.uk/book/being-interdisciplinary/)
:::
:::::
...
::: {.column width="50%"}
![](images/Python-logo-notext.svg.png){width="20%"} ![](images/R_logo.svg.png){width="20%"} ![](images/Stata_logo_med_blue.png){width="20%"} ![](images/spss-1-logo-png-transparent.png){width="20%"} ![](images/statsmodels-logo-v2-horizontal.svg){width="20%"} ![](images/tidy_models.png){width="20%"}
:::
:::::
...
ggplot(england_filtered) +
  ...
  labs(title = "England and Wales Schools - Attainment 8 \nvs % Overall Absence, 2022-23",
       x = "log(% Overall Absence)",
       y = "log(Average Attainment 8 Score)") +
  theme_minimal()
```

-   If we recall from some of the background slides, significant research to suggest overall levels of absence an important factor in attainment
...
-   The simple bivariate model for Overall Absence improves the $R^2$ value to 60% (compared to 45% for the % disadvantage model)
-   This suggests that Overall Absence might explain more of the variation in Attainment 8, but one way to really tell is to put them in a model together
...
-   In the presence of Overall Absence, the effect of disadvantage is confounded
