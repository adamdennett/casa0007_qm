...
-   Can regression help us and How can we go about carefully building a regression model to help us answer these questions?
...
-   As with baking a cake, failure failure will follow if you don't:
   -   get your ingredients right
   -   follow the method correctly 
   -   use your tools in the right way
:::
...
## Step 1a - Ingredients {transition="convex-in none-out" transition-speed="fast"}
...
-   Failure to get to know your data properly means you might misspecify your model by:
    ...
    -   misunderstanding your data types - counts vs continuous
    -   misunderstanding the relationships between your variables (linear vs logarithmic)
    -   not accounting for important spatial or temporal patterns that might mean your observations are not independent
...
## Step 1b - Ingredient Familiarisation {transition="convex-in none-out" transition-speed="fast"}
