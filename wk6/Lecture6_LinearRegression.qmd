...
![](wk6/images/Correlation_examples2.png)
...
-   Interpreting the log-log relationship:
    ...
    -   On our original plot that the effect of levels of disadvantage on attainment is much stronger at very low levels of disadvantage and weakens as the level of disadvantage increases
...
-   Use when the effect of the independent variable has diminishing returns.
    -   e.g. a change from 10 to 11 has a larger effect than a change from 100 to 101. Common with variables like income or population size
...
## Interpretation for Brighton and Hove
